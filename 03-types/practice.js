...
var isSuit = function (suit) {
    ...
    return suits.indexOf(suit.toLowerCase())!=-1;
};
...
// objects.
var isHTMLElement = function (s) {
    var openTag=s.slice(s.indexOf("<")+1,s.indexOf(">"));
    var closeTag=s.slice(s.lastIndexOf("<")+1,s.lastIndexOf(">"));
